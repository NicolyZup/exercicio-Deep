...
public class CarroService {
    ...
    public double registrarSaidaCarro(String placa) {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                String atualizarStatusCarroSQL = "UPDATE carros SET status = FALSE WHERE id = "+idCarro;
                PreparedStatement stmtRemoverCarro = connection.prepareStatement(atualizarStatusCarroSQL);
    ...
    private static double calcularValorPermanencia(Date dataEntrada, Time horaEntrada) {
        ...
        LocalTime horaAtual = LocalTime.now().truncatedTo(ChronoUnit.SECONDS); //truncatedTo ignora os nanos segundos
